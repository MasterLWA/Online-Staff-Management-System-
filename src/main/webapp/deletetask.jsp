...
<body>
		...
		<div class="container">
			<div
				...
				<ul
					...
					<li><a href="#" class="nav-link px-2 text-prymary"> /  Delete Task ( <%= title %> )</a></li>
				</ul>
			</div>
		</div>
	</header>
	...
	<div class="px-4 py-5  text-center">
		<img class="d-block mx-auto mb-4" src="images/icons8-delete-96.png"
			alt="">
		<h1 class="display-5 fw-bold">DELETE TASK?</h1>
	...
	<%-- <form action="tdelete" method = "POST">
		...
		Task title <br>
		<input type = "text" name = "task_title"  value="<%=title%>" readonly> <br>
		<br>
				...
				<div class="card">
					...
					<form action="tdelete" method = "POST">
							...
							<div class="mb-3">
								...
								<input class = "form-control"  type = "text" name = "task_title"  value="<%=title%>" readonly>
							</div>
